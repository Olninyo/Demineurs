...
Shader "SH_Form"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#else
				half staticSwitch331 = saturate( max( VertexAlpha308 , pow( saferPower339 , 2.2 ) ) );
			#endif
...
/*ASEBEGIN
Version=18800
0;73;1920;928;1222.987;-1345.925;1.675001;True;False
...
ASEEND*/
//CHKSM=6EFB79AE498FC80A93B52FAEE0C6D885B3E825F0