...
Shader "SH_Form"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half saferPower264 = max( ( Edges111 * DetailPattern_R149 * 50 ) , 0.0001 );
			...
			half saferPower289 = max( ( Cavities219 * DetailPattern_G148 * 10 ) , 0.0001 );
			half4 temp_cast_1 = (( saturate( pow( saferPower289 , 2.0 ) ) * 0.05 )).xxxx;
			half4 HeightColour181 = _HeightMaskColour;
			half4 lerpResult170 = lerp( saturate( ( ( ( tex2DNode281 + ( tex2DNode281 * Edges111 ) ) + ( saturate( pow( saferPower264 , 5.0 ) ) * 0.05 ) ) - temp_cast_1 ) ) , HeightColour181 , heightGradientMask168);
...
/*ASEBEGIN
Version=18800
1920;0;1920;1019;852.2616;-503.7863;1.284999;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;266;-340.6946,1216.197;Inherit;False;149;DetailPattern_R;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;295;-275.2973,1606.315;Inherit;False;Constant;_CavityStrength;CavityStrength;21;0;Create;True;0;0;0;False;0;False;10;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.PowerNode;264;76.73051,1172.105;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;289;158.6179,1423.855;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;291;479.9318,1420.777;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.05;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=33F49AAAF8DB50CDF1300F3FA3436216E790A3ED