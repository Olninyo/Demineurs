...
Shader "SH_Form"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 temp_cast_1 = (( saturate( pow( saferPower289 , 1.0 ) ) * 0.075 )).xxxx;
			half4 HeightColour181 = _HeightMaskColour;
			half4 lerpResult170 = lerp( saturate( ( ( tex2D( _Albedo, uv2_Albedo ) + ( saturate( pow( saferPower264 , 1.0 ) ) * 0.075 ) ) - temp_cast_1 ) ) , HeightColour181 , heightGradientMask168);
...
/*ASEBEGIN
Version=18800
1920;0;1920;1019;849.3797;-802.2454;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;287;393.9037,1154.892;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.075;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;291;478.5968,1420.442;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.075;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F14EEAE63C1B0F05EA59F795CD47C9C807CCD01E