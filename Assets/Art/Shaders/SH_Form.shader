...
Shader "SH_Form"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			Unity_GlossyEnvironmentData g79 = UnityGlossyEnvironmentSetup( (0), data.worldViewDir, ase_worldNormal, float3(0,0,0));
			...
			c.rgb = ( half4( (( _ReflectionToggle )?( ( lerpResult81 * heightGradient112 ) ):( float3( 0,0,0 ) )) , 0.0 ) + ( ( (( _IndirectToggle )?( ( ( globalIllumination110 + ( albedo129 / 4.0 ) ) * half4( indirectDiffuse14 , 0.0 ) ) ):( float4( 0,0,0,0 ) )) + half4( (( _FresnelToggle )?( ( fresnelNode76 * ase_lightAtten * ase_lightColor.rgb ) ):( float3( 0,0,0 ) )) , 0.0 ) + half4( (( _LightingToggle )?( ( (( _CustomLightFalloffToggle )?( max( (dotResult7*_lightwrapscale + _lightwrapoffset) , 0.0 ) ):( max( dotResult7 , 0.0 ) )) * ( ase_lightAtten * ase_lightColor.rgb ) ) ):( float3( 0,0,0 ) )) , 0.0 ) ) * (( _AlbedoToggle )?( albedo129 ):( float4( 1,1,1,0 ) )) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18800
1920;0;1920;1019;1269.26;-20.02192;1.595001;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;93;-1059.841,-1090.284;Inherit;False;-1;;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;108;-999.5287,730.1092;Inherit;False;Property;_CustomLightFalloffToggle;Custom Light Falloff Toggle;9;0;Create;True;0;0;0;False;0;False;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=9FDE91FBD9493E2697E436F3237509508551C4FD