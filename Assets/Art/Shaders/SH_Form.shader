...
Shader "SH_Form"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half3 normalizeResult37_g5 = normalize( ase_worldPos );
			half ZenithMask59_g5 = saturate( max( normalizeResult37_g5.y , 0.0 ) );
			half4 lerpResult87_g5 = lerp( unity_AmbientGround , unity_AmbientSky , ZenithMask59_g5);
			half NadirMask60_g5 = saturate( ( min( normalizeResult37_g5.y , 0.0 ) * -1.0 ) );
			half HorizonFalloff69_g5 = (0.01 + (_HorizonFalloff - 0.0) * (25.0 - 0.01) / (1.0 - 0.0));
			half smoothstepResult73_g5 = smoothstep( 0.0 , 1.0 , pow( ( 1.0 - ( ZenithMask59_g5 + NadirMask60_g5 ) ) , HorizonFalloff69_g5 ));
			half HorizonMask76_g5 = smoothstepResult73_g5;
			half4 lerpResult95_g5 = lerp( lerpResult87_g5 , unity_AmbientEquator , HorizonMask76_g5);
			half4 temp_output_97_0_g5 = ( lerpResult95_g5 * 0.75 );
			half4 AltitudeColours99_g5 = temp_output_97_0_g5;
			half SunColour138_g5 = _SunColour.r;
			half4 temp_cast_6 = (SunColour138_g5).xxxx;
			half3 normalizeResult114_g5 = normalize( ase_worldViewDir );
			half dotResult115_g5 = dot( _SunDirection , normalizeResult114_g5 );
			half SunAtmosMask139_g5 = pow( ( ( _SunAtmosDensity / 3.0 ) * max( ( 2.0 + ( 1.0 - acos( dotResult115_g5 ) ) ) , 0.0 ) ) , (2.0 + (_SunAtmosFalloff - 0.0) * (50.0 - 2.0) / (1.0 - 0.0)) );
			half4 lerpResult110_g5 = lerp( AltitudeColours99_g5 , temp_cast_6 , SunAtmosMask139_g5);
			half4 SkyAtmos359 = lerpResult110_g5;
			...
			half4 lerpResult349 = lerp( ( half4( (( _ReflectionToggle )?( reflection153 ):( float3( 0,0,0 ) )) , 0.0 ) + ( ( (( _IndirectToggle )?( Indirect151 ):( float4( 0,0,0,0 ) )) + half4( (( _FresnelToggle )?( Fresnel155 ):( float3( 0,0,0 ) )) , 0.0 ) + half4( (( _LightingToggle )?( Lighting157 ):( float3( 0,0,0 ) )) , 0.0 ) ) * (( _AlbedoToggle )?( albedo129 ):( float4( 1,1,1,0 ) )) ) ) , SkyAtmos359 , SkyAtmosMask363);
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf StandardCustomLighting keepalpha fullforwardshadows nolightmap  nodynlightmap nodirlightmap nofog dithercrossfade vertex:vertexDataFunc tessellate:tessFunction 
...
/*ASEBEGIN
Version=18800
0;73;1920;928;536.9623;161.5945;1.065001;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;193;-3004.871,2021.561;Inherit;False;Property;_WorldGradientOffset;World Gradient Offset;32;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;197;-2969.179,2176.352;Inherit;False;Property;_WorldGradientScale;World Gradient Scale;33;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;145;-2229.312,-1854.097;Inherit;True;Property;_DetailMask;Detail Mask;19;0;Create;True;0;0;0;False;0;False;95fb59503f3acf040b94dae940963d73;95fb59503f3acf040b94dae940963d73;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;166;-2255.429,1872.57;Inherit;False;Property;_HeightGradientScale;Height Gradient Scale;35;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;177;-1690.778,1992.428;Inherit;False;Property;_HeightGradientPatternStrength;Height Gradient Pattern Strength;36;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;203;-1203.663,1906.335;Inherit;False;Property;_HeightGradient;Height Gradient;40;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;172;-1925.257,2208.917;Inherit;False;Property;_HeightMaskColour;Height Mask Colour;38;0;Create;True;0;0;0;False;0;False;0.5,0.5,0.5,0;0.5,0.5,0.5,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-905.1546,-1820.582;Inherit;False;Property;_Gloss;Gloss;31;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1878.607,978.1422;Inherit;False;Property;_lightwrapscale;light wrap scale;20;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1865.783,1094.233;Inherit;False;Property;_lightwrapoffset;light wrap offset;21;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-2189.696,-484.1892;Inherit;False;Property;_LightFresnel;Light Fresnel;22;0;Create;True;0;0;0;False;0;False;3.60606;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;75;-2183.696,-276.1895;Inherit;False;Property;_LightFresnelPower;Light Fresnel Power;24;0;Create;True;0;0;0;False;0;False;4.323316;2;0.01;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;108;-1184.547,728.5142;Inherit;False;Property;_CustomLightFalloffToggle;Custom Light Falloff Toggle;30;0;Create;True;0;0;0;False;0;False;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;250;-365.8394,-170.6563;Inherit;False;1322.913;834.1477;;16;349;360;364;128;103;127;126;43;154;140;104;105;106;158;156;152;COMPOSITE;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;105;-72.85355,159.416;Inherit;False;Property;_FresnelToggle;Fresnel Toggle;27;0;Create;True;0;0;0;False;0;False;1;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ToggleSwitchNode;104;-91.43725,10.86987;Inherit;False;Property;_IndirectToggle;Indirect Toggle;26;0;Create;True;0;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;106;-70.79145,309.8952;Inherit;False;Property;_LightingToggle;Lighting Toggle;28;0;Create;True;0;0;0;False;0;False;1;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;140;-309.8537,485.3165;Inherit;False;129;albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;353;-747.1304,2790.299;Inherit;False;Property;_SunColour;Sun Colour;12;1;[HDR];Create;True;0;0;0;False;0;False;2,1.47451,0.972549,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;354;-806.4727,2990.882;Inherit;False;Property;_SunAtmosDensity;Sun Atmos Density;10;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;355;-802.3374,3100.117;Inherit;False;Property;_SunAtmosFalloff;Sun Atmos Falloff;11;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;361;-2142.452,2873.487;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;365;-353.4372,2846.991;Inherit;False;SHF_SkyboxAtmos;0;;5;17edc35a0a6a77a4e97013dfc1d7324b;0;4;140;FLOAT;0.5;False;141;FLOAT;0;False;142;FLOAT;0.9;False;143;FLOAT;0.6;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;126;-85.53494,460.6005;Inherit;False;Property;_AlbedoToggle;Albedo Toggle;29;0;Create;True;0;0;0;False;0;False;1;2;0;COLOR;1,1,1,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;342;601.5053,1892.615;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;103;-98.60773,-120.6563;Inherit;False;Property;_ReflectionToggle;Reflection Toggle;25;0;Create;True;0;0;0;False;0;False;1;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;359;47.62207,2850.093;Inherit;False;SkyAtmos;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;360;356.5616,342.9595;Inherit;False;359;SkyAtmos;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;364;341.8365,436.2288;Inherit;False;363;SkyAtmosMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;280;855.9542,1413.762;Inherit;True;Property;_Albedo;Albedo;13;0;Create;True;0;0;0;False;0;False;-1;4b47542f94d80e84fbf0f9cda3727ed6;4b47542f94d80e84fbf0f9cda3727ed6;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;184;-2462.317,1746.552;Inherit;False;Property;_HeightMaskWorldSpace;Height Mask World Space;39;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;329;824.5139,2151.877;Inherit;True;Property;_DitherNoise;DitherNoise;37;0;Create;True;0;0;0;False;0;False;c5dfece29a2a5f4498d0616dcad73f65;c5dfece29a2a5f4498d0616dcad73f65;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;167;-3026.204,1694.478;Inherit;False;Property;_HeightGradientOffset;Height Gradient Offset;34;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;190;-2006.14,1750.047;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;331;819.9081,1992.109;Inherit;False;Property;_LOD_FADE_CROSSFADE;LOD_FADE_CROSSFADE;24;0;Create;True;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;349;739.6038,137.0417;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1347.3,-100.1051;Half;False;True;-1;6;ASEMaterialInspector;0;0;CustomLighting;SH_Form;False;False;False;False;False;False;True;True;True;True;False;False;True;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;23;-1;-1;14;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;365;140;352;0
WireConnection;365;141;353;0
WireConnection;365;142;354;0
WireConnection;365;143;355;0
...
ASEEND*/
//CHKSM=BC5F07C0226A90200FDE473180BC975CCB77DBD0