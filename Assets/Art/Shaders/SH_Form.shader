...
Shader "SH_Form"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 albedo129 = (( _AlbedoToggle )?( tex2D( _Albedo, uv_Albedo ) ):( float4( 1,1,1,0 ) ));
			UnityGI gi14 = gi;
			...
			c.rgb = ( half4( (( _ReflectionToggle )?( ( lerpResult81 * heightGradient112 ) ):( float3( 0,0,0 ) )) , 0.0 ) + ( ( (( _IndirectToggle )?( ( ( globalIllumination110 + ( albedo129 / 2.0 ) ) * half4( indirectDiffuse14 , 0.0 ) ) ):( float4( 0,0,0,0 ) )) + half4( (( _FresnelToggle )?( ( fresnelNode76 * ase_lightAtten * ase_lightColor.rgb ) ):( float3( 0,0,0 ) )) , 0.0 ) + half4( (( _LightingToggle )?( ( (( _CustomLightFalloffToggle )?( max( (dotResult7*_lightwrapscale + _lightwrapoffset) , 0.0 ) ):( max( dotResult7 , 0.0 ) )) * ( ase_lightAtten * ase_lightColor.rgb ) ) ):( float3( 0,0,0 ) )) , 0.0 ) ) * (( _AlbedoToggle )?( tex2D( _Albedo, uv_Albedo ) ):( float4( 1,1,1,0 ) )) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18800
1920;18;1920;1001;1507.697;906.9792;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;120;-393.5419,1077.665;Inherit;True;Property;_Albedo;Albedo;14;0;Create;True;0;0;0;False;0;False;-1;None;4b47542f94d80e84fbf0f9cda3727ed6;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;129;372.2594,437.4943;Inherit;False;albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;99;-1000.852,-634.1455;Inherit;False;953.782;402.0547;;7;15;14;131;130;113;132;133;INDIRECT;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;133;-897.6968,-350.9792;Inherit;False;Constant;_Float4;Float 4;15;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;104;131.583,-50.03011;Inherit;False;Property;_IndirectToggle;Indirect Toggle;9;0;Create;True;0;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=18DC0E215C82466303A9CA80F5EBB1EE833F6E15