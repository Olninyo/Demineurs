...
Shader "SH_Form"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			half4 ase_vertex4Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			half4 ase_clipPos = ComputeScreenPos( UnityObjectToClipPos( ase_vertex4Pos ) );
			half dither343 = DitherNoiseTex(ase_clipPos, _DitherNoise, _DitherNoise_TexelSize);
			...
			c.rgb = ( half4( (( _ReflectionToggle )?( reflection153 ):( float3( 0,0,0 ) )) , 0.0 ) + ( ( (( _IndirectToggle )?( Indirect151 ):( float4( 0,0,0,0 ) )) + half4( (( _FresnelToggle )?( Fresnel155 ):( float3( 0,0,0 ) )) , 0.0 ) + (( _LightingToggle )?( Lighting157 ):( float4( 0,0,0,0 ) )) ) * (( _AlbedoToggle )?( albedo129 ):( float4( 1,1,1,0 ) )) ) ).rgb;
			c.a = 1;
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf StandardCustomLighting keepalpha fullforwardshadows nolightmap  nodynlightmap nodirlightmap dithercrossfade vertex:vertexDataFunc tessellate:tessFunction 
...
/*ASEBEGIN
Version=18800
1920;0;1920;1019;3429.716;66.30188;1.574933;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;193;-3004.871,2021.561;Inherit;False;Property;_WorldGradientOffset;World Gradient Offset;33;0;Create;True;0;0;0;False;0;False;0;-39.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;197;-2969.179,2176.352;Inherit;False;Property;_WorldGradientScale;World Gradient Scale;34;0;Create;True;0;0;0;False;0;False;1;25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;166;-2255.429,1872.57;Inherit;False;Property;_HeightGradientScale;Height Gradient Scale;36;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;177;-1690.778,1992.428;Inherit;False;Property;_HeightGradientPatternStrength;Height Gradient Pattern Strength;37;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;203;-1203.663,1906.335;Inherit;False;Property;_HeightGradient;Height Gradient;41;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;172;-1925.257,2208.917;Inherit;False;Property;_HeightMaskColour;Height Mask Colour;39;0;Create;True;0;0;0;False;0;False;0.5,0.5,0.5,0;0.5499999,0.5133331,0.3299999,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-2734.803,786.4366;Inherit;False;Property;_lightwrapscale;light wrap scale;20;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-2721.979,927.3377;Inherit;False;Property;_lightwrapoffset;light wrap offset;21;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-905.1546,-1820.582;Inherit;False;Property;_Gloss;Gloss;32;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;388;-2251.832,1212.17;Inherit;False;Property;_Keyword0;Keyword 0;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;UNITY_PASS_FORWARDBASE;Toggle;2;Key0;Key1;Fetch;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;108;-2040.742,561.6194;Inherit;False;Property;_CustomLightFalloffToggle;Custom Light Falloff Toggle;31;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;380;-1736.706,564.6489;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;106;-70.79145,309.8952;Inherit;False;Property;_LightingToggle;Lighting Toggle;28;0;Create;True;0;0;0;False;0;False;1;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;329;1043.525,2147.037;Inherit;True;Property;_DitherNoise;DitherNoise;38;0;Create;True;0;0;0;False;0;False;c5dfece29a2a5f4498d0616dcad73f65;c5dfece29a2a5f4498d0616dcad73f65;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ToggleSwitchNode;105;-72.85355,159.416;Inherit;False;Property;_FresnelToggle;Fresnel Toggle;27;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;349;788.0843,-53.84843;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;184;-2462.317,1746.552;Inherit;False;Property;_HeightMaskWorldSpace;Height Mask World Space;40;0;Create;True;0;0;0;False;0;False;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;360;494.9313,-88.31048;Inherit;False;359;SkyAtmos;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=E628F4530A14015865702896B31BA4BEA506C250