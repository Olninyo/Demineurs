...
Shader "OSW/SH_Flora"
{
	Properties
	{
		...
		_AlbedoColour("Albedo Colour", Color) = (0.4676306,0.5019608,0.2454589,0)
	...
	SubShader
	{
		...
		{
			float3 hsvTorgb28 = RGBToHSV( _AlbedoColour.rgb );
			float3 hsvTorgb32 = HSVToRGB( float3(hsvTorgb28.x,saturate( ( hsvTorgb28.y + 0.1 ) ),saturate( ( hsvTorgb28.z + 0.05 ) )) );
			...
			float4 lerpResult33 = lerp( _AlbedoColour , float4( hsvTorgb32 , 0.0 ) , saturate( fresnelNode26 ));
			...
			float4 Albedo21 = ( (( _FresnelGamma )?( lerpResult33 ):( _AlbedoColour )) * tex2DNode19 );
...
/*ASEBEGIN
Version=18800
1920;0;1920;1019;3546.388;1011.611;1.025;True;False
...
Node;AmplifyShaderEditor.ColorNode;10;-3432.946,-691.1312;Inherit;False;Property;_AlbedoColour;Albedo Colour;1;0;Create;True;0;0;0;False;0;False;0.4676306,0.5019608,0.2454589,0;0.4433961,0.4164496,0.2237895,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;40;-2800.872,-455.2736;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-2807.555,-338.5288;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.05;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;26;-2623.215,-234.051;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-2079.83,1058.122;Inherit;False;Property;_BillboardSize;Billboard Size;2;0;Create;True;0;0;0;False;0;False;1;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-1803.648,720.7612;Inherit;False;Property;_BillboardInflate;Billboard Inflate;4;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-1258.124,1098.568;Inherit;False;Property;_BillboardAmount;Billboard Amount;3;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-1951.758,-203.9498;Inherit;True;Property;_FloraAlbedo;Flora Albedo;5;0;Create;True;0;0;0;False;0;False;-1;4684d9a9a8c4a1043a03d70df774cbf1;4684d9a9a8c4a1043a03d70df774cbf1;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;43;-1795.065,-691.0652;Inherit;False;Property;_FresnelGamma;Fresnel Gamma;6;0;Create;True;0;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=BD44CE40AB155CBB6AD87A78A7659DC265AD0472