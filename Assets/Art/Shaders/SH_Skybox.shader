...
Shader "SH_Skybox"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode193 = tex2D( _DetailPattern, ( UVs95 * float2( 1,0.5 ) ) );
			...
			float lerpBlendMode227 = lerp(blendOpDest227,(( blendOpDest227 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest227 ) * ( 1.0 - blendOpSrc227 ) ) : ( 2.0 * blendOpDest227 * blendOpSrc227 ) ),0.25);
...
/*ASEBEGIN
Version=18800
1913;24;1920;995;5629.566;2249.916;1.625003;True;False
...
Node;AmplifyShaderEditor.Vector3Node;100;-5389.593,-2851.472;Inherit;False;Global;_SunDirection;_SunDirection;8;0;Create;True;0;0;0;False;0;False;0.5,0.5,0.5;-0.5492356,-0.389847,-0.7391617;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.BlendOpsNode;229;-4546.636,-1822.304;Inherit;False;ColorBurn;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.02;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;213;-4336.302,-1587.67;Inherit;False;ColorDodge;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;227;-4636.511,-912.6743;Inherit;False;Overlay;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.25;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=18376DD14367E629D319756925AFDCFB6F5F1750