...
Shader "OSW/Water"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 openWaterUV413 = panner333;
			float2 temp_output_412_0 = ( openWaterUV413 / float2( 2,2 ) );
			float2 temp_cast_6 = (( time302 * 0.5 )).xx;
			float simplePerlin2D379 = snoise( ( temp_output_412_0 + ( time302 * 20.0 ) )*0.25 );
			simplePerlin2D379 = simplePerlin2D379*0.5 + 0.5;
			float lerpResult346 = lerp( ( max( tex2D( _Height, openWaterUV413 ).r , tex2D( _Height, ( temp_output_412_0 - temp_cast_6 ) ).r ) + simplePerlin2D379 ) , tex2D( _Height, rippleUV410 ).r , rippleMask405);
			float displacementRaw401 = lerpResult346;
			float4 refraction261 = ( lerpResult228 + ( lerpResult228 * displacementRaw401 ) );
...
/*ASEBEGIN
Version=18800
1920;0;1920;1019;609.5994;-109.6756;2.794775;True;False
Node;AmplifyShaderEditor.CommentaryNode;195;536.5412,848.4501;Inherit;False;3701.612;1059.535;;50;328;326;327;329;315;330;257;298;299;227;212;297;319;294;293;214;313;337;225;309;308;336;338;339;303;192;333;332;305;300;206;306;331;197;194;334;209;207;205;204;382;391;399;397;405;410;413;423;425;428;NORMALS;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;168;-2899.562,-1576.912;Inherit;False;3350.918;938.181;;30;403;261;228;232;267;273;270;282;280;8;275;240;404;63;402;276;289;7;5;277;286;290;279;285;219;160;223;184;213;224;REFRACTION;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;340;1091.324,2197.093;Inherit;True;Property;_Height;Height;24;2;[Header];[NoScaleOffset];Create;True;1;Displacement;0;0;False;0;False;f293baeaf87cdff4687cd0bfb5bc69b5;f293baeaf87cdff4687cd0bfb5bc69b5;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;361;2525.755,2448.137;Inherit;False;Property;_displacementstrength;displacement strength;26;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;404;-302.2972,-1418.621;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;403;-104.303,-1517.779;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D92C2D0DE237E4449F659B28771299D3EDBED118