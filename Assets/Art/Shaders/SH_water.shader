...
Shader "OSW/Water"
{
	Properties
	{
		...
		[Header(Depth)]_waterdepth("water depth", Range( 0 , 100)) = 75.8225
		_waterdepthfalloff("water depth falloff", Range( 0 , 10)) = 5
		_shoreopacity("shore opacity", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		uniform float _waterdepthfalloff;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult30 = clamp( (1.0 + (( eyeDepth216 - i.eyeDepth ) - 0.0) * (0.0 - 1.0) / (_waterdepth - 0.0)) , 0.0 , 1.0 );
			float depth_refracted61 = pow( clampResult30 , _waterdepthfalloff );
			float4 lerpResult8 = lerp( _deepcolour , _shallowcolour , depth_refracted61);
			float clampResult77 = clamp( ( (0.0 + (depth_refracted61 - 0.0) * (1.0 - 0.0) / (0.9 - 0.0)) + _shoreopacity ) , 0.0 , 1.0 );
			float4 lerpResult167 = lerp( lerpResult8 , _shorecolour , clampResult77);
			...
			float4 lerpResult228 = lerp( lerpResult167 , ( saturate( 2.0f*blendOpDest232*blendOpSrc232 + blendOpDest232*blendOpDest232*(1.0f - 2.0f*blendOpSrc232) )) , depth_refracted61);
...
/*ASEBEGIN
Version=18800
1920;0;1920;1019;1881.665;763.8635;1.66137;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;197;400.0498,672.1943;Inherit;False;Property;_wavenormaltile;wave normal tile;15;0;Create;True;0;0;0;False;0;False;0;0;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;192;400.6848,366.1265;Inherit;True;Property;_wavesnormal;waves normal;14;3;[Header];[NoScaleOffset];[Normal];Create;True;1;Waves;0;0;False;0;False;b8b43c26acee0b94f9fae5c1dbb29d55;b8b43c26acee0b94f9fae5c1dbb29d55;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;214;692.045,545.6073;Inherit;False;Property;_wavenormalstrength;wave normal strength;16;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;168;-1381.137,-606.28;Inherit;False;2255.505;769.107;;25;76;171;40;167;77;8;159;160;7;5;63;184;200;213;219;223;224;228;229;231;232;240;243;242;247;REFRACTION;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-614.1791,26.02627;Inherit;False;Property;_refractionIOR;refraction IOR;12;1;[Header];Create;True;1;Refraction;0;0;False;0;False;1;1;-5;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;219;36.45052,67.91298;Inherit;False;refractionUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-2707.427,155.4797;Float;False;Property;_waterdepth;water depth;4;1;[Header];Create;True;1;Depth;0;0;False;0;False;75.8225;25;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-2210.973,187.5173;Inherit;False;Property;_waterdepthfalloff;water depth falloff;5;0;Create;True;0;0;0;False;0;False;5;5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;61;-1758.27,-19.76024;Float;False;depth_refracted;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;171;-989.8171,-235.3837;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.9;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1119.605,-31.08916;Float;False;Property;_shoreopacity;shore opacity;6;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;7;-1277.578,-361.0576;Float;False;Property;_deepcolour;deep colour;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1490195,0.2980391,0.1642255,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;5;-1279.936,-556.28;Float;False;Property;_shallowcolour;shallow colour;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6078431,0.8,0.6,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;174;179.9292,-1295.849;Inherit;False;757.3679;493.712;;4;89;75;45;46;ALBEDO;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;75;265.6958,-971.8291;Inherit;False;73;foam_mask;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;167;-391.8715,-482.942;Inherit;False;3;0;COLOR;1,1,1,0;False;1;COLOR;1,1,1,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;232;282.638,-413.1729;Inherit;False;SoftLight;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;89;504.8355,-965.6077;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;240;48.38668,-38.22751;Inherit;False;61;depth_refracted;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;46;384.4772,-1205.612;Float;False;Property;_foamcolour;foam colour;0;1;[Header];Create;True;1;Colour;0;0;False;0;False;0.8,0.8,0.8,1;0.8,0.8,0.8,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;200;-399.1417,-333.0002;Inherit;False;depthShallows;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;194;440.184,576.4446;Inherit;False;191;shoreUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;242;339.0907,-118.4436;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;229;32.94651,-117.9209;Inherit;False;Property;_refractionopacity;refraction opacity;13;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;228;706.4211,-473.7593;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;247;335.1451,-263.4223;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;243;540.3365,-326.5415;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=0D47D311A309B63A0B92258B07C1067FCB86B106